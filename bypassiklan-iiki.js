...
(function() {
    ...
    BypassedByakuiiki(/ultraten.net|uniqueten.net|techydino.net|crewbase.net|crewus.net|shinchu.net|thumb8.net|allcryptoz.net|topcryptoz.net|thumb9.net|shinbhu.net/, function() {const form = document.getElementById('wpsafelink-landing')
    ...
    if(window.location.hostname== 'tei.ai'){ window.addEventListener('DOMContentLoaded', (event) => {
            ...
            window.location.href ="+linkbypass;});}else {}
    let $ = window.jQuery;
   if (location.href.indexOf("temp-late.xyz") != -1 || location.href.indexOf("template-zone.xyz") != -1 || location.href.indexOf("top-blog.xyz") != -1) {} else if (window.location.hostname == 'upfiles.io') {
    ...
    const l = (h => {switch (h.host) {
        ...
        case 'mdn.world': document.querySelector('.btn-primary.btn').click(); break;
        case 'adsy.pw': case 'linkpay.cc': document.querySelector('#link-view').submit(); break;
        case 'yalla-shoot-now.us': case 'forexat.club': document.querySelector('#links > form:nth-child(2)').submit(); break;
